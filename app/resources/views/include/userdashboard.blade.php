            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <ul class="topbar-nav">
                    <li class="topbar-nav-item relative"><span
                            class="user-welcome d-none d-lg-inline-block">Welcome! {{Auth::user()->fname}} {{Auth::user()->lname}}</span>
                        ...
                        <div
                            ...
                            <div class="user-status"><h6 class="user-status-title">Referral Bonus</h6>
                                <div class="user-status-balance">{{number_format(Auth::user()->bonus, $basic->decimal)}}
                                    <small>{{$basic->currency}}</small></div>


                            </div>
                            <ul class="user-links">
                                <li><a href="{{route('notifications')}}"><i class="ti ti-announcement"></i>Notifications</a>
                                </li>
        ...
        <div class="container">
            <div class="navbar-innr">
                <ul class="navbar-menu">
                    ...
                    <li><a href="{{route('home')}}"><em class="text-primary ti ti-dashboard"></em>&nbsp; Dashboard</a>
                    </li>


                    <li class="has-dropdown page-links-all"><a class="drop-toggle" href="#"><em
                                class="text-primary ti ti-wallet"></em>&nbsp; Blockchain Wallet</a>
                        <ul class="navbar-dropdown"></li>
                            <? $coins = DB::table('coins')->get(); ?>
                            @foreach($coins as $data)
                                <li><a href="{{route('blockchainwallet', $data->id)}}"><em
                                            class="text-primary cf cf-{{$data->symbol}}"></em>&nbsp; {{$data->name}}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
                    ...
                    <li class="has-dropdown page-links-all"><a class="drop-toggle" href="#"><em
                                class="text-primary ti ti-wallet"></em>&nbsp; Deposit</a>
                        <ul class="navbar-dropdown"></li>
                            <li><a href="#" data-toggle="modal" data-target="#deposit-fiat"><em
                                        class="text-primary ti ti-wallet"></em>&nbsp; Deposit Fiat</a></li>
                            <li><a href="#" data-toggle="modal" data-target="#deposit-coin"><em
                                        class="text-primary ti ti-server"></em>&nbsp; Deposit Crypto</a></li>
                            <li><a href="{{route('user.depositLog')}}"><em class="text-primary ti ti-book"></em>&nbsp;
                                    Deposit Log</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="has-dropdown page-links-all"><a class="drop-toggle" href="#"><em
                                class="text-primary ti ti-credit-card"></em>&nbsp; Trade</a>
                        <ul class="navbar-dropdown">
                            <li class="has-dropdown"><a class="drop-toggle" href="#"><em
                                        class="text-primary ti ti-shopping-cart"></em>&nbsp; Buy E-Currency</a>
                                <ul class="navbar-dropdown">
                                    <li><a href="{{route('buy')}}">Buy From System</a></li>
                                    <li><a href="{{route('buyonmarket')}}">Buy From User</a></li>
                                </ul>
                            </li>

                            <li><a href="{{route('sellonmarket')}}"><em class="text-primary ti ti-server"></em>&nbsp;
                                    Sell To System </a></li>
                            <li><a href="{{route('sellonmarket')}}"><em class="text-primary ti ti-upload"></em>&nbsp;
                                    Create Offer </a></li>
                            <li class="has-dropdown"><a class="drop-toggle" href="#"><em
                                        class="text-primary ti ti-home"></em>&nbsp; My Store</a>
                                <ul class="navbar-dropdown">
                                    <li><a href="{{route('closeddeal')}}">Closed Deals</a></li>
                                    <li><a href="{{route('activedeal')}}">Active Deals</a></li>
                                </ul>
                            </li>
                            <li><a href="{{route('transaction')}}"><em class="text-primary ti ti-book"></em>&nbsp;
                    ...
                    <li class="has-dropdown page-links-all"><a class="drop-toggle" href="#"><em
                                class="text-primary ti ti-credit-card"></em>&nbsp; Finance</a>
                        <ul class="navbar-dropdown">
                            <li class="has-dropdown"><a class="drop-toggle" href="#"><em
                                        class="text-primary ti ti-server"></em>&nbsp; Withdrawals</a>
                                <ul class="navbar-dropdown">
                                    <li><a href="{{route('withdraw.money')}}">New Withdrawal</a></li>
                                    <li><a href="{{route('user.withdrawLog')}}">Withdrawal Log </a></li>
                                </ul>
                            </li>
                            <li class="has-dropdown"><a class="drop-toggle" href="#"><em
                                        class="text-primary ti ti-reload"></em>&nbsp; Transfer Fund</a>
                                <ul class="navbar-dropdown">
                                    <li><a href="{{route('transfer')}}">New Transfer</a></li>
                                    <li><a href="{{route('transferlog')}}">Transfer Log </a></li>
                                </ul>
                            </li>
                            <li><a href="{{route('convertbonus')}}"><em class="text-primary ti ti-server"></em>&nbsp;
                                    Convert Bonus </a></li>
                    ...
                    <li class="page-links-all"><a href="{{route('verification')}}"><em
                                class="text-primary ti ti-id-badge"></em>&nbsp; Verification</a></li>


                    <li class="has-dropdown page-links-all"><a class="drop-toggle" href="#"><em
                                class="text-primary ti ti-user"></em>&nbsp; Profile</a>
                        <ul class="navbar-dropdown"></li>
                            <li class=" "><a class="" href="{{route('profile')}}">My Profile</a></li>
                            <li class=" "><a class="" href="{{route('bank')}}">Bank Account</a></li>
                    ...
                    @endphp
                    <li class="has-dropdown page-links-all"><a class="drop-toggle" href="#"><em
                                class="text-primary ti ti-email"></em>&nbsp; Messages </a>
                        <ul class="navbar-dropdown"></li>
                            <li class=" "><a class="" href="{{route('createmessage')}}">Create Message</a></li>

                            <li class=" "><a class="" href="{{route('inbox')}}">Messages Inbox @if($count > 0) <span
                                        class="badge badge-warning">{{$count}} New</span>@endif</a></li>
...
@endif
<!-- Modal End -->
<div class="modal fade" id="deposit-fiat" tabindex="-1">
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content pb-0">
            <div class="popup-body"><h4 class="popup-title">Fund Your Deposit Wallet</h4>
                <p class="lead">You currently have
                    <span>{{$basic->currency}}{{number_format(Auth::user()->balance, $basic->decimal)}}</span> in your
                    deposit wallet. Fill the form below to proceed.</p>
                <p>You can choose any of following payment method to fund your wallet. The fund will appear in your
                    account after successfull payment.</p><h5 class="mgt-1-5x font-mid">Select payment method:</h5>
                <form method="post" action="{{route('deposit.data-insert')}}">
                    ...
                    <select class="input-bordered select-block" required name="gateway">
                        ...
                        @foreach($gates as $gate)
                            <option data-charge="{{$gate->percent_charge}}"
                                    value="{{$gate->id}}">{{$gate->name}}</option>
                        @endforeach
                    </select>
                    ...
                    <div class="pdb-2-5x pdt-1-5x"><input required type="checkbox"
                                                          class="input-checkbox input-checkbox-md"
                                                          id="agree-term-3"><label for="agree-term-3">I hereby agree to
                            the <strong>{{$basic->sitename}} agreement &amp; deposit terms term</strong>.</label></div>
                    <ul class="d-flex flex-wrap align-items-center guttar-30px">
                        <li>
                            <button type="submit" class="btn btn-primary">Accept &amp; Process Payment <em
                                    class="ti ti-arrow-right mgl-2x"></em></a>
                        </li>
                    </ul>
...
<!-- Modal End -->
<div class="modal fade" id="deposit-coin" tabindex="-1">
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content pb-0">
            <div class="popup-body"><h4 class="popup-title">Fund Your Deposit Wallet</h4>
                <p class="lead">You currently have
                ...
                <form method="post" action="{{route('deposit.data-insert')}}">
                    ...
                    <div class="pdb-2-5x pdt-1-5x"><input required type="checkbox"
                                                          class="input-checkbox input-checkbox-md"
                                                          id="agree-term-31"><label for="agree-term-31">I hereby agree
                            to the <strong>{{$basic->sitename}} agreement &amp; deposit terms</strong>.</label></div>
                    <ul class="d-flex flex-wrap align-items-center guttar-30px">
                        <li>
                            <button type="submit" class="btn btn-primary">Accept &amp; Process Payment <em
                                    class="ti ti-arrow-right mgl-2x"></em></a>
        ...
        <div class="modal-dialog modal-dialog-md modal-dialog-centered">
            <div class="modal-content">
                <div class="popup-body text-center">
                    ...
                    <p>Its a new day to earn your daily bonus. Please click the button below to earn
                        your {{$basic->currency_sym}}{{$basic->bonus}} bonus for the day</p>
                    <div class="gaps-2x"></div>
        ...
        <div class="modal-dialog modal-dialog-md modal-dialog-centered">
            <div class="modal-content">
                <div class="popup-body text-center">
                    ...
                    <p>Sorry, You have already earned your bonus for the day. Please come back later for new
                        earning.<br> Time remaining for next earning: <strong>
