                                        ...
                                        @if(count($trx) >0)
                                            @foreach($trx as $k=>$data)
                                                <div class="nk-tb-item">
                                                    ...
                                                    <div class="nk-tb-col tb-col-dlg">
                                                        <span class="tb-lead">{{isset($data->trx ) ? $data->trx  : 'N/A'}}</span>
                                                        @if($data->status == 1)
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="nk-modal-head mt-sm-5 mt-4 mb-4"><h5 class="title">Transaction Info</h5></div>
                                                                ...
                                                                <div class="nk-modal-head mt-sm-5 mt-4 mb-4"><h5 class="title">Payment Details</h5></div>
                                                                    <div class="row gy-3">
                                                                        <div class="col-lg-6"><span class="sub-text">Sell Amount</span><span class="caption-text">{{round($data->main_amo/$data->currency->price,4)}}</span></div>
                                                                        <div class="col-lg-6">
                                                                            <span class="sub-text">Expected Amount</span><span class="caption-text align-center">{{$data->main_amo}} $</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
