                            ...
                            <div class="nk-content-body">
                                ...
                                @endif
                                    ...
                                    <div class="nk-data data-list">
                                        <div class="data-head"><h6 class="overline-title">Wallet Details</h6></div>
                                        <div class="data-item" data-toggle="modal" data-target="#profile-edit" data-tab-target="#address">
                                            <div class="data-col">
                                                <span class="data-label">Stellar Address</span>
                           ...
                           <form method="post" action="{{route('post.banky') }}">
                            ...
                            <div class="tab-pane active" id="address">
                             <form method="post" action="{{route('post.banky') }}">
                                ...
                                <div class="row gy-4">
                                    <div class="col-md-12">
                                        <div class="form-group"><label class="form-label" for="address-l1">Paypal Address</label><input type="text" readonly class="form-control form-control-lg" id="address-l1"  name="paypal"  value="{{isset(Auth::user()->paypal) ? Auth::user()->paypal : 'N/A'}}" /></div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group"><label class="form-label" for="address-l1">Stellar Wallet Address</label><input type="text" readonly class="form-control form-control-lg" id="address-l1" name="btc" value="{{isset($address) ? $address : 'N/A'}}" /></div>
                                    </div>
