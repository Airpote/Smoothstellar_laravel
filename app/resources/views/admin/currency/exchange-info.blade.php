                ...
                <div class="card-innr">
                    ...
                    <ul class="data-details-list">
                        <li>
                            ...
                            <div class="data-details-des"><strong>Exchange</strong></div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">From</div>
                            <div class="data-details-des">
                                <strong>{{$exchange->from_amount}} {{$exchange->fromCurrency->symbol}} <small>- What
                                        User Have</small></strong></div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">To</div>
                            <div class="data-details-des">
                                <strong>{{$exchange->receive_amount}} {{$exchange->toCurrency->symbol}}<small>- What
                                        User Gets</small></strong></div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">Charge</div>
                            <div class="data-details-des">
                                <span>{{$exchange->from_amount_charge}} {{$exchange->toCurrency->symbol}} {{$exchange->toCurrency->symbol}}</span>
                                <span></span></div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">TRX Number</div>
                        ...
                        @if($exchange->type > 0)
                            <li>
                                ...
                                <div class="data-details-des">
                                    <span><strong>{{$exchange->transaction_number}}</strong></span></div>
                            </li>

                            <li><br>
                                <div class="data-details-head">Payment Screenshot</div>
                                <div class="data-doc-item data-doc-item-lg">
                                    <div class="data-doc-image"><img src="{{asset('exchange/'.$exchange->image)}}"
                                                                     alt="..." class="img-thumbnail"></div>
                                    <ul class="data-doc-actions">
                                        <li><a href="{{asset('exchange/'.$exchange->image)}}" download><em
                    ...
                    @endif<!-- li -->
                        ...
                        <li>
                            ...
                            <div class="data-details-des"><span>{{$exchange->user->username}}</span> <span></span></div>
                        </li>

                        <!-- li -->
                        <li>
                            <div class="data-details-head">Email</div>
                            <div class="data-details-des">{{$exchange->user->email}}</div>
                        </li><!-- li --></ul><!-- .data-details -->
                    <div class="gaps-3x"></div>
                    <h6 class="card-sub-title">Payment Details</h6>
                    <ul class="data-details-list">
                        <li>
                            <div class="data-details-head">Coin Name</div>
                            <div class="data-details-des"><strong>{{$exchange->toCurrency->name}}</strong></div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">Wallet Address</div>
                            <div class="data-details-des"><span><strong>{{$exchange->info}}</strong> <em
                                        class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom"
                                        title=""
                                        data-original-title="{{$exchange->toCurrency->name}} Wallet Address"></em></span>
                            </div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">Units To Credit</div>
                            <div class="data-details-des">
                                <strong>{{$exchange->receive_amount}} {{$exchange->toCurrency->symbol}}
                                    <small>- {{$exchange->toCurrency->name}}</small></strong></div>
                        </li>
                    </ul><!-- .data-details --></div>
