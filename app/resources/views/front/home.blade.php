                    ...
                    <div class="col-12 col-md-6 col-xl-5 offset-xl-1 pr-sm-6 pr-md-0 remove-space--bottom steps-wrapper">
                        <div class="step position-relative d-flex align-items-start pb-6 reveal">
                            ...
                            <div class="position-relative">
                                ...
                                <p class="opacity--80">Have a wallet already? Skip this step <span class="text-color--cta--5">Login To Wallet</span>.</p>
                            </div>
                            <!-- end of content -->
                        </div>
                        <!-- end of single step -->
                        <div class="step position-relative d-flex align-items-start pb-6 reveal">
                            ...
                            <div class="position-relative">
                                ...
                                <p class="opacity--80">Simply <span class="text-color--cta--5">open a new account</span>to start buying and selling crypto assets.</p>
                            </div>
                            <!-- end of content -->
                        </div>
                        <!-- end of single step -->
                        <div class="step position-relative d-flex align-items-start pb-6 reveal">
                            ...
                            <div class="position-relative">
                                ...
                                <p class="opacity--80"><span class="text-color--cta--5">Buy</span> or <span class="text-color--cta--5">Sell</span> crypto assets through our secure platform.</p>
                            </div>
                            <!-- end of content -->
                        </div>
                        <!-- end of single step -->
