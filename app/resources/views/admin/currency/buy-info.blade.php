                ...
                <div class="card-innr">
                    ...
                    <ul class="data-details-list">
                        ...
                        <li>
                            ...
                            <div class="data-details-des"><strong>{{number_format($exchange->main_amo, $basic->decimal)}}
                                    USD</strong></div>
                        </li><!-- li -->
                        <li>
                        ...
                        <li>
                            ...
                            <div class="data-details-des">
                                <span>{{number_format($exchange->getamo , 6)}}{{$basic->currency}}</span>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      
                            </div>
                        </li><!-- li -->
                        <li>
                    ...
                    <ul class="data-details-list">
                        ...
                        <li>
                            ...
                            <div class="data-details-des">
                                <span><strong>{{number_format($exchange->amountpaid , 5)}} {{$exchange->remark}}</strong>  </span>
                                <!-- <span>({{number_format($exchange->amount - $exchange->charge, $basic->decimal)}} {{$basic->currency}} + {{$exchange->currency->buy}}%)</span> -->
                            </div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">TRX Charge</div>
                            <div class="data-details-des">
                                <strong>{{number_format($exchange->charge, $basic->decimal)}} USD
                                    <!-- <small> {{$exchange->currency->buy}}%</small> -->
                                </strong></div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">{{$exchange->currency->symbol}} To Receive</div>
                            <div class="data-details-des">
                                <span>{{number_format($exchange->getamo, 6)}} {{$exchange->currency->symbol}}</span>
                            </div>
                        </li><!-- li -->
                        <li>
                            <div class="data-details-head">Amount To Credit</div>
                            <div class="data-details-des">
                                <span>${{$exchange->amount}} worth of {{$exchange->currency->symbol}}</span><span>({{$exchange->currency->name}})</span>
                            </div>
                        </li><!-- li -->
                        <li>
