...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::get('validate/{id}', 'HomeController@validatebank')->name('bank.vvalidate');
        ...
        Route::get('/buy-bscoin', 'HomeController@buybscoin')->name('buy.bscoin');
        Route::post('/buy-bsecoin', 'HomeController@buybsecoin')->name('buybsecoin');
        Route::get('/ebuy-paypal/{id}', 'PaypalController@createPayment')->name('user.ebuypaypal');
        Route::post('/confirm-paypal', 'PaypalController@confirmPayment')->name('confirm-payment');
        ...
        Route::get('/get_balance', 'HomeController@getBalance')->name('getbalance');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin'], function () {
 ...
 //Sms Api
    ...
    Route::post('/clear_wallet', 'AdminController@clear_wallet')->name('admin.clear_wallet');
    ...
    Route::get('/add_stellarwallet','AdminController@add_stellarwallet')->name('admin.addstellarwallet');
    Route::post('/add_stellarwallet','AdminController@save_stellarwallet')->name('admin.savestellarwallet');

    Route::get('/view_stellarassets','AdminController@view_assets')->name('admin.view_assets');
    Route::get('/charge_SMC','AdminController@charge_smc')->name('charge_asset');
    Route::get('/active_stellarassets/{id}','AdminController@active_assets')->name('activateasset');
    Route::get('/deactive_stellarassets/{id}','AdminController@deactive_assets')->name('deactivateasset');
    Route::get('/del_stellarassets/{id}','AdminController@del_assets')->name('deleteasset');
    Route::post('/add_stellarassets','AdminController@add_asset')->name('admin.add_asset');
    //*  end wallet *//
});
