        ...
        <div class="container-xl wide-lg">
            <div class="nk-content-body">
                <div class="buysell  ">
                    ...
                    <div class="buysell-title text-center"><h4 class="title">Buy Smooth Coin</h4></div>
                    <div class="buysell-block">
                        ...
                        <form method="post" class="buysell-form" action="{{ route('buyecoin') }}">
                            ...
                            <div class="buysell-field form-group">
                                <div class="form-label-group"><label class="form-label">Choose what you want to
                                        get</label></div>
                                               ...
                                               data-toggle="dropdown">
                                                <div class="coin-item coin-btc">
                                                    <div class="coin-icon" id="icon1"><em
                                                            class="icon ni ni-sign-usdc-alt"></em></div>
                                                    <div class="coin-info"><span class="coin-name" id="pname">Payment Method</span><span
                                                            class="coin-text" id="slogan1">Select Payment</span></div>
                                                </div>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-auto dropdown-menu-mxh">
                                                <ul class="buysell-cc-list">
                                                    ...
                                                    @foreach($method as $data)
                                                        ...
                                                        <li class="buysell-cc-item" onclick="goDoSomething1(this);"
                                                            data-id="{{$data->name}}" data-method="{{$data->id}}"
                                                            data-id3="tranx" data-id2="Payment Method">
                                                            <a href="#" class="buysell-cc-opt" data-currency="eth">
                                                                <div class="coin-item coin-eth">
                                                                    <div class="coin-icon"><em
                                                                            class="icon ni ni-tranx"></em></div>
                                                                    <div class="coin-info"><span
                                                                            class="coin-name">{{$data->name}}</span><span
                                                                            class="coin-text">Payment Method</span>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </li>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="dropdown buysell-cc-dropdown">
                                            <a href="#" class="buysell-cc-choosen dropdown-indicator"
                                               data-toggle="dropdown">
                                                <div class="coin-item coin-btc">
                                                    <div class="coin-icon" id="icon2"><em
                                                            class="icon ni ni-sign-usdc-alt"></em></div>
                                                    <div class="coin-info"><span class="coin-name"
                                                                                 id="bname">Bank Name</span><span
                                                            class="coin-text" id="slogan2">Select Bank</span></div>
                                                </div>
                                            </a>
                                            <div class="dropdown-menu dropdown-menu-auto dropdown-menu-mxh">
                                                <ul class="buysell-cc-list">
                                                    @foreach($bank as $data)
                                                        ...
                                                        <li class="buysell-cc-item" onclick="goDoSomething2(this);"
                                                            data-bank="{{$data->id}}" data-id="{{$data->name}}"
                                                            data-id3="building" data-id2="Bank Name">
                                                            <a href="#" class="buysell-cc-opt" data-currency="eth">
                                                                <div class="coin-item coin-eth">
                                                                    <div class="coin-icon"><em
                                                                    ...
                                                                    <div class="coin-info"><span
                                                                            class="coin-name">{{$data->name}}</span><span
                                                                            class="coin-text">(Bank Name)</span></div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                    @endforeach
                            ...
                            <div class="buysell-field form-action">
                                <button type="button" data-toggle="modal" data-target="#buy-coin"
                                        class="btn btn-lg  btn-outline btn-primary" style="margin-top:20px">Buy
                                </button>
                            </div>
                                            ...
                                            <div class="nk-block-head nk-block-head-xs text-center"><h5
                                                ...
                                                <div class="nk-block-text">
                                                    <div class="caption-text">You are about to purchase <strong><a
                                                                id="amount"></a> USD</strong> worth of <strong><a
                                                                id="coins"></a></strong>*
                                                    </div>
                                                    <span class="sub-text-sm">Exchange rate: 1 <a id="coins2"></a> = <a
                                                            id="rate2"></a> USD</span></div>
                                            </div>
                                            <div class="nk-block">
                                                <div class="buysell-overview">
                                                    <ul class="buysell-overview-list">
                                                        ...
                                                        <li class="buysell-overview-item"><span
                                                                class="pm-title">Total</span>
                                                            <span class="pm-currency"><a
                                                                    id="amount2">0.00</a> USD</span></li>
                                                    </ul>
                                                ...
                                                <div class="buysell-field form-group">
                                                    ...
                                                    <div class="buysell-field form-group">
                                                        <div class="form-label-group"><label class="form-label"
                                                                    ...
                                                                    id="gateway2"></a></label></div>
                                                        <div class="form-control-group">
                                                            <input type="test" class="form-control form-control-lg  r"
                                                                   name="wallet"/>
                                                            <div class="form-dropdown">
