                                ...
                                <form method="post" class="coin-form" action="{{ route('admin.save_coin') }}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-group">
                                            <input type="text" id="coin_name" class="form-control form-control-lg" name="coin_name" placeholder="Please Enter the Coin Name" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-group">
                                            <input type="number" id="coin_maount" class="form-control form-control-lg" name="coin_amount" placeholder="Please Enter the Coin Amount" />
                                        </div>
                                    </div>
