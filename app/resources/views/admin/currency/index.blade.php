                ...
                <div class="card-innr">
                    ...
                    <table class="data-table dt-init user-list">
                        ...
                        <tr class="data-item data-head">
                            ...
                            <th class="data-col dt-email">Address</th>
                            <th class="data-col dt-token">Rate</th>
                        ...
                        <a href="#" data-toggle="modal" data-target="#createcoin"
                           class="btn btn-sm btn-primary btn-outline"><em class="ti ti-trash"></em> Create New</a>
                        @foreach($currency as $k=>$data)
                            <tr class="data-item">
                                <td class="data-col dt-user"><span class="lead user-name">{{$data->name }}</span><span
                                        class="sub user-id"></span></td>
                                <td class="data-col dt-email"><span
                                        class="lead sub-s2 sub-email">{{$data->payment_id}}</span></td>
                                <td class="data-col dt-token"><span class="lead lead-btoken">1 {{$data->symbol}} =
    {{$data->price}} USD</span></td>
                                    ...
                                    <div class="relative d-inline-block"><a href="#"
                                        ...
                                        <div class="toggle-class dropdown-content dropdown-content-top-left">
                                            <ul class="dropdown-list">
                                                <li><a href="{{route('currency.edit',$data->id)}}"><em
                                                            class="ti ti-eye"></em> View Details</a></li>
                                                <li><a href="{{route('activatecoin',$data->id)}}"><em
                                                            class="ti ti-check"></em> Activate</a></li>
                                                <li><a href="{{route('deactivatecoin',$data->id)}}"><em
                                                            class="ti ti-na"></em> Deactivate</a></li>

                                                <li><a href="{{route('deletecoin',$data->id)}}"><em
    ...
    <div class="modal fade" id="createcoin" tabindex="-1">
        <div class="modal-dialog modal-dialog-md modal-dialog-centered">
            <div class="modal-content">
                <div class="popup-body"><h4 class="popup-title">Create New Currency</h4>
                    <p>Fill the form below to create a new cryptocurrency for the system. Please note that the currency
                        symbol has to conform with the standart blockchain currency symbol. Please check <a
                            href="https://min-api.cryptocompare.com">Here</a> to see list of supported currency symbols.
                    </p>

                    <div class="input-item input-with-label">

                        <form role="form" method="POST" action="{{route('currency.store')}}" name="editForm"
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="input-bordered" placeholder="Currency  Name"
                                               value="{{old('name')}}"
                                               name="name">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="input-bordered" placeholder="Currency Symbol"
                                           value="{{old('symbol')}}"
                                           name="symbol">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="payment_id" value="{{old('payment_id')}}"
