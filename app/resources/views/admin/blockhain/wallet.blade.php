                            ...
                            <div class="card-innr">
                                ...
                                <div class="total-block">
                                    <ul class="list total-wg">
                                        <li>
                                            <span class="total-title-xs">Sent {{$coin->currency}}</span>
                                            <? $total_sent = 0;
                                        ...
                                        <li>
                                            ...
                                            <span class="total-title-xs">Received {{$coin->currency}}</span>
                    ...
                    <div class="card-innr">
                        <div class="user-account-status">
                            ...
                            <div class="gaps-1-5x"></div>
                                <ul class="btn-grp">
                                    <li><a href="#" data-toggle="modal" data-target="#receive-coin" class="btn btn-xs btn-auto btn-success">Receive {{$coin->currency}}</a></li>
                                    <li><a href="#" data-toggle="modal" data-target="#send-coin" class="btn btn-xs btn-auto btn-info"><span>Send {{$coin->currency}}</span></a></li>
                                </ul>
                            </div>
                            <div class="gaps-2-5x"></div>
                            <div class="user-receive-wallet">
                                <h6 class="card-title card-title-sm">Wallet Address</h6>
                                <div class="gaps-1x"></div>
                                <div class="d-flex justify-content-between"><span>{{$address}} </div>
                            </div>
                        </div>
                    </div>
