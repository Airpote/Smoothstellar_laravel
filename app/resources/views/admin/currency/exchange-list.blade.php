    ...
    <div class="page-content">
        <div class="container">
            <div class="content-area card">
                <div class="card-innr">
                    <div class="card-head"><h4 class="card-title">Exchange Log</h4></div>
                    ...
                    <table class="data-table dt-filter-init admin-tnx">
                        ...
                        <tr class="data-item data-head">
                            ...
                            <th class="data-col dt-token">From</th>
                        ...
                        @foreach($exchange as $k=>$data)
                            <tr class="data-item">
                                ...
                                <td class="data-col dt-token"><span
                                        class="lead token-amount">{{$data->from_amount}} </span><span
                                        class="sub sub-symbol">{{$data->fromCurrency->symbol}}</span></td>
                                <td class="data-col dt-amount"><span
                                        class="lead amount-pay">{{$data->receive_amount}} </span><span
                                        class="sub sub-symbol">{{$data->toCurrency->symbol}} <em
                                            class="fas fa-info-circle" data-toggle="tooltip" data-placement="bottom"
                                            title="{{$data->toCurrency->name}}"></em></span></td>
                                <td class="data-col dt-account"><span
                                        class="lead user-info">{{$data->toCurrency->name}}</span></td>
                                    ...
                                    <div class="relative d-inline-block"><a href="#"
                                        ...
                                        <div class="toggle-class dropdown-content dropdown-content-top-left">
                                            <ul class="dropdown-list">
                                                <li><a href="{{route('exchange-info',$data->id)}}"><em
                                                            class="ti ti-eye"></em> View Details</a></li>

                                                @if($data->status == 1)
                                                    <li><a href="{{route('exchange.approve',$data->id)}}"><em
                                                                class="ti ti-check-box"></em> Approve</a></li>

                                                    <li><a href="{{route('exchange.reject',$data->id)}}"><em
